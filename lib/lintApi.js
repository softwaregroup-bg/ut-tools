...
module.exports = function() {
    ...
    /* const openapi = */ exec('npx', [
        'spectral', 'lint', './system/api/**/openapi.json', '--ruleset', ruleset,
        ...rec ? ['-f', 'stylish', '-f', 'json', '--output.json', './.lint/lint-openapi.json'] : []
    ], 'inherit', 'stdout', true, true);
    /* const swagger = */ exec('npx', [
        'spectral', 'lint', './system/api/**/swagger.json', '--ruleset', ruleset,
