...
module.exports = function(from) {
    ...
    var UTRE = /^git@((git\.ssoftwaregroup\.com:ut5)|(github\.com:softwaregroup-bg))\/ut-.*\.git$/;
    var UTIMPLRE = /^git@git\.ssoftwaregroup\.com:ut5impl\/impl-.*\.git$/;
    var L1PRE = /^git@github.com:LevelOneProject\/((dfsp-)|(ist-)).*\.git$/;
    var GITHUBRE = /^git@github.com/;
    var SGRE = /^git@git\.ssoftwaregroup\.com:ut5/;
