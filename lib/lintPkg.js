...
module.exports = function(from) {
    ...
    const SVCRE = /^git@git\.softwaregroup\.com:dw\/(standard\/standard-service(-\w{2,})+|impl\/(\w{2,}-){0,}\w{2,}\/impl(-\w{2,})+-service(-\w{2,})+)\.git$/;
    ...
    const L1PRE = /^git@github.com:LevelOneProject\/(dfsp|ist)(-\w+)+\.git$/;
